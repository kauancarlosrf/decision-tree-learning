...
arvore = construir_arvore(data_frame_dados_restaurante, data_frame_decisoes_restaurante)
...
print("Decisão:", prever(arvore, novo_exemplo11))  # Espera "não" ou "sim" com base na árvore
print("Decisão:", prever(arvore, novo_exemplo12))  # Espera "não" ou "sim" com base na árvore


# Construir a árvore treinada no DataSet FUTEBOL
arvore = construir_arvore(data_frame_dados_futebol, data_frame_decisoes_futebol)
...
print("Decisão:", prever(arvore, novo_exemplo21))  # Espera "perder" ou "ganhar" com base na árvore
print("Decisão:", prever(arvore, novo_exemplo22))  # Espera "perder" ou "ganhar" com base na árvore
